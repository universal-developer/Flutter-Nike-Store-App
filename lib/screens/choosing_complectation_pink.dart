...
class ChoosingComplectationPinkScreen extends StatefulWidget {
  const ChoosingComplectationPinkScreen({Key? key}) : super(key: key);

  @override
  _ChoosingComplectationPinkScreenState createState() => _ChoosingComplectationPinkScreenState();
}

class _ChoosingComplectationPinkScreenState extends State<ChoosingComplectationPinkScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xffECBEEA),
      appBar: AppBar(
      ...
      body: Stack(
        children: [
          const RotationTransition(
            ...
            child: Image(image: AssetImage('assets/nike_image_foor-2.png'), width: 500),
          ),
                        ...
                        child: ElevatedButton(
                            ...
                            style: ButtonStyle(
                                backgroundColor: MaterialStateProperty.all<Color>(
                                    const Color(0xffECBEEA)),
                                shape: MaterialStateProperty.all<
                                    RoundedRectangleBorder>(
                                  RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(18.0),
                                    side:
                                    const BorderSide(color: Color(0xffECBEEA)),
                                  ),
                                ))),
                      ),
                    ),
